...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for user in all_users:
            ...
            if location_missing or about_missing:
                gec = ProfileCompletionEmail()
                gec.send(username=user.username, recipient_list=[user.email], location_missing=location_missing, about_missing=about_missing)
